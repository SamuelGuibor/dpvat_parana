          ...
          >
            <div className="flex w-full items-center justify-between gap-12 lg:gap-80 lg:w-auto">
              ...
              <button
                ...
                className={`${scrolled ? "text-black cursor-pointer" : "text-white cursor-pointer"} relative z-20 -m-2.5 -mr-4 block p-2.5 lg:hidden`}
                >
              ...
              <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit justify-center items-center">
                <div className="relative flex gap-4">
                  <Link href="https://www.facebook.com/paranadpvat/">
                    <FaFacebook size={30} className={scrolled ? "text-black cursor-pointer" : "lg:text-white text-black cursor-pointer"} />
                  </Link>
                  <Link href="https://www.instagram.com/paranadpvat/">
                    <FaInstagram size={30} className={scrolled ? "text-black cursor-pointer" : "lg:text-white text-black cursor-pointer"} />
                  </Link>
                </div>
