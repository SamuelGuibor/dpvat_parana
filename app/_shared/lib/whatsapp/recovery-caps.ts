...
// (1578951027140630) — o número "Seguros Paraná IA" cai pra 2 provocações:
// 1 texto livre na janela de 24h + a despedida em template. Os demais números
// seguem no teto padrão. Chave = phoneNumberId da Meta (estável e visível no
...
export const RECOVERY_MAX_BY_PHONE_NUMBER_ID: Record<string, number> = {
  '1267705099752954': 2, // Seguros Paraná IA
};
