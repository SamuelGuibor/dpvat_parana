...
const blogPosts = [
    ...
    },
    {
        ...
        excerpt: 'Descubra em quais situações você pode solicitar indenização por danos morais e como calcular o valor justo da sua reparação.',
        image: 'https://images.unsplash.com/photo-1581998392741-67879e0ef04a?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
...
const popularPosts = [
    ...
    {
        title: 'Danos Morais em Acidentes de Trânsito',
        date: '1 de Dezembro, 2025',
    },
];
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-gradient-to-br from-blue-900 to-blue-700 text-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-4xl lg:text-5xl mb-4">Blog IndeniJuris</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Newsletter */}
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-xl text-gray-900 mb-3">Newsletter</h3>
                            <p className="text-gray-600 mb-4">
                                Receba as últimas atualizações e artigos diretamente no seu e-mail
                            </p>
